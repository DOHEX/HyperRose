...
/** ROSESELSA EARFEEL i5 全部控制/查询命令。 协议帧前缀：请求 08 EE / 回包 09 FF 通信通道：BLE GATT */
object RoseCommandSet {
    ...
    fun gameModeCommand(enabled: Boolean): ByteArray = if (enabled) GAME_MODE_ON else GAME_MODE_OFF
