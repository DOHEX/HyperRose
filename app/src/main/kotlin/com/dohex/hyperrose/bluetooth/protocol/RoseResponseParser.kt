...
object RoseResponseParser {
    ...
    /**
     * 解析电量回包。 格式: [header 11B] [LL] [RR] [LC] [RC] [CC] [CS]
     * - LL/RR: 左/右耳电量 (0-100)
    ...
    /**
     * 解析 ANC 模式回包。 判定字节 [8..11] 中哪一位为 01 来确定模式：
     * - [8]=01 → 降噪, [9]=01 → 普通, [10]=01 → 风噪/通透 完整模式: 降噪 01 00 00 00 / 普通 00 01 00 00 / 风噪 00 00 01
     *   00 / 通透 00 00 00 01
     */
