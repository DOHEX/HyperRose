...
import com.dohex.hyperrose.ui.animation.DampedDragAnimation
import com.dohex.hyperrose.ui.animation.InteractiveHighlight
...
object FloatingBottomBarDefaults {
    /** 页面需要为悬浮栏预留的内容底部空间。悬浮栏本身仍覆盖在页面之上。 */
    val ContentBottomPadding: Dp = 112.dp
...
/**
 * 通用悬浮玻璃底栏：与具体 UI 家族无关。
 *
 * 负责点击/拖拽切页、按压形变、回弹、倾斜高光和液态玻璃三层绘制
 * （主体、隐藏选中态记录层、选中指示器）。
 */
@Composable
fun <T> FloatingBottomBar(
    ...
    val isInDark = when (MiuixTheme.colorSchemeMode) {
